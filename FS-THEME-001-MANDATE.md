...
**Engine Version:** `FS-THEME-001-v1.0.1-20260907`  
...
- `opacity < 0.85` kullanımı yasaktır (Tüm renkler solid hesaplanmalıdır)
...
2. **Surface Elevation:** Solid hex color ile layer ayrımı (`#0F172A`)
3. **Text:** `#E2E8F0` (off-white) — pure white `#FFFFFF` yasak
4. **Desaturation:** Tüm primary colors %15-20 desature edilmeli
5. **Halation Prevention:** Text shadow `0 0 0 transparent` (reset)
...
2. **Surface Elevation:** Shadow-based (0px 1px 3px #E2E8F0)
...
□ Disabled state'ler solid renkler ile %40 kontrast eşdeğerinde
