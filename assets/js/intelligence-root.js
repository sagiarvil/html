...
const copy={
  tr:{
    kicker:'ÜCRETSİZ KONTROL KATMANI · %100 ÜCRETSİZ ($0)',
    ...
    t0Desc:'Ne yanlış? Nerede? 13 puan dışı istihbarat analizi, 7 hazırlık lensi ve skor dışı 6 ileri black-box risk alanı kanıt sınırlarıyla ücretsiz gösterilir.',
    ...
    evidenceLabel:'TEKNİK KANIT',
    boundaryLabel:'Metodoloji Notu',
    auditDiagNotice:'Kontrol: Ücretsiz Açık · Tüm Onarımlar: $99 Tek Paket İçinde',
    capstoneCta:'🔒 AI Görünürlük Onarım Setini Al — $99 →',
    bridgeTag:'KONTROL TAMAMLANDI · PEKİ ŞİMDİ?',
    bridgeTitle:'13 Açık ve Kanıtlar Ortada. Bunları Kod Seviyesinde Düzeltmeye Hazır mısınız?',
    bridgeDesc:'Ücretsiz raporda eksikleri ve kanıtları gördünüz. Sitedeki TÜM sorunların çözümü TEK BİR $99 Onarım Setindedir. Skoru yükseltmek için tüm kilidi tek seferde açın.',
  ...
  en:{
    ...
    t0Desc:'What is wrong and where? 13 non-scoring intelligence analyses, 7 readiness lenses and 6 non-scoring advanced black-box risk analyses expose the available evidence and the evidence gaps for free.',
