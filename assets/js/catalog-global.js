(() => {
  ...
  style.textContent = `
    ...
    .hh-render-shell{
      ...
      overflow:hidden;
      background:#fff;
      border-bottom:1px solid rgba(24,28,37,.1);
    }
    .hh-render-viewport{
      position:relative;
      width:100%;
    ...
    .hh-preview-badge{
      ...
      color:#2d3440;
      box-shadow:0 6px 18px rgba(20,27,43,.1);
      font-size:.62rem;
      font-weight:900;
      letter-spacing:.09em;
      text-transform:uppercase;
    ...
    .product-visual.has-real-preview::after{
    ...
    .product-visual.has-real-preview:hover::after{opacity:1;transform:none}
    .product-visual.has-real-preview:hover .visual-label{opacity:0}
    @media(max-width:760px){
      .hh-render-viewport{min-height:245px}
      .product-visual.has-real-preview::after{display:none}
    }
    ...
    visual.innerHTML = `
      <div class="hh-render-shell" aria-hidden="true">
        <div class="hh-render-viewport">
          ...
          <div class="hh-render-loading">Loading actual template</div>
        </div>
      </div>
      <span class="hh-preview-badge">Actual template render</span>
