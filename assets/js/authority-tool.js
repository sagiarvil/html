...
const copy={tr:{scanning:'Site taranıyor; seçili motorlar 12-motor tarama zinciri içinde çalışıyor…',failed:'Tarama tamamlanamadı.',clear:'Bu kapsamda doğrulanmış sorun bulunmadı.',score:'seçili kapsam skoru',checked:'kontrol',pages:'sayfa',finding:'bulgu',severity:'Önem',confidence:'Güven',source:'Kaynak'},en:{scanning:'Scanning the site; selected engines run inside the full 12-engine chain…',failed:'Scan could not be completed.',clear:'No verified issue was found in this scope.',score:'selected-scope score',checked:'checks',pages:'pages',finding:'findings',severity:'Severity',confidence:'Confidence',source:'Source'}}[lang];
const sevMap={tr:{critical:'KRİTİK',high:'YÜKSEK',medium:'ORTA',low:'DÜŞÜK',info:'BİLGİ'},en:{critical:'CRITICAL',high:'HIGH',medium:'MEDIUM',low:'LOW',info:'INFO'}};const confMap={tr:{confirmed:'DOĞRULANMIŞ',strong:'GÜÇLÜ',probable:'OLASI','requires-source-verification':'KAYNAK DOĞRULAMASI GEREKİR'},en:{confirmed:'CONFIRMED',strong:'STRONG',probable:'PROBABLE','requires-source-verification':'SOURCE VERIFICATION REQUIRED'}};const srcMap={tr:{OFFICIAL_STANDARD:'RESMİ STANDART',OFFICIAL_VENDOR:'RESMİ SAĞLAYICI',PROPOSAL:'ÖNERİ',MEASURED:'ÖLÇÜLMÜŞ',INTERNAL_HEURISTIC:'İÇ SEZGİSEL KURAL',EXPERIMENTAL:'DENEYSEL'},en:{}};function esc(v){return String(v??'').replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]))}
