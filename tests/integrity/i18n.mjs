...
const trTools=read('tr/araclar/index.html'),trPricing=read('tr/fiyatlandirma/index.html');
if(!trTools.includes('data-premium-infographic="scope-map"'))errors.push('TR tools missing scope-map infographic');
if(!trPricing.includes('data-premium-infographic="report-boundary"'))errors.push('TR pricing missing report-boundary infographic');
