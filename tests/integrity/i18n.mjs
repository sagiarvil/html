...
for(const marker of ['data-premium-infographic="tools"','data-premium-infographic="engines"','data-premium-infographic="process"']){if(!main.includes(marker))errors.push(`main missing ${marker}`);if(!trHome.includes(marker))errors.push(`TR home missing ${marker}`);if(!enHome.includes(marker))errors.push(`EN home missing ${marker}`)}
