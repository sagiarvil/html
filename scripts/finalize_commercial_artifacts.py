...
THEME='<link rel="stylesheet" href="/assets/css/theme.css?v=19">'
PREMIUM='<link rel="stylesheet" href="/assets/css/premium-experience.css?v=19">'
...
validator=ROOT/'assets/js/validator.js?v=17'
if validator.exists():
