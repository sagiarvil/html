...
INTENT = {
    "tr": {
        ...
        "fix-mandate": "$99 Fix Mandate, ‘AI sizi tavsiye eder’ vaadi değil; yapay zeka arama görünürlüğü ve tavsiye fırsatı önündeki ölçülmüş engeller için kök neden, uygulama sırası, test ve rollback kod paketidir.",
    ...
    "en": {
        ...
        "fix-mandate": "The $99 Fix Mandate is not an AI recommendation promise. It is a root-cause, implementation, testing and rollback package for measured blockers to AI search visibility and source eligibility.",
