...
PAGES = {
    ...
    "tr/fiyatlandirma/index.html": {"h1":"Yapay Zeka Görünürlüğünüzü Ücretsiz Ölçün. Düzeltme Reçetesini $149'a Açın.","lead":"Önce yapay zeka arama sonuçlarında görünme ve tavsiye edilme fırsatınızı engelleyen sorunları ücretsiz görün. Yalnızca uygulama reçetesi için ödeme yapın."},
    "en/pricing/index.html": {"h1":"Measure AI Search Readiness Free. Unlock the $149 Fix Prescription Only If Needed.","lead":"See the website-side blockers to AI visibility and recommendation opportunity free. Pay only when you want implementation-grade remediation."},
    "tr/fix-mandate/index.html": {"h1":"Yapay Zeka Görünürlüğünüzün Önündeki Engelleri Uygulanabilir Düzeltme Reçetesine Çevirin.","lead":"$149 Fix Mandate bir tavsiye garantisi değil; ölçülen GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt ve teknik engelleri kök neden, uygulama, test ve rollback planına dönüştüren sözleşmedir."},
    "en/fix-mandate/index.html": {"h1":"Turn AI Search Visibility Blockers into a Testable Fix Prescription.","lead":"The $149 Fix Mandate is not a recommendation guarantee. It turns measured GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt and technical blockers into root-cause fixes, tests and rollback."},
