...
PAGES = {
    "index.html": {
        "title": "AI Arama Teknik Teşhis ve Düzeltme Platformu | HTML&HTML",
        "description": "Web sitenizin AI aramalarında neden zayıf kaldığını ücretsiz görün. Bulguyu kanıtlayın; gerekiyorsa $99 Fix Pack ile uygulanabilir düzeltme, test ve rollback planını alın.",
        "h1": "Web Siteniz Yapay Zeka Aramalarında Neden Görünmüyor?",
        "lead": "URL'nizi girin. Sitenizin bulunmasını, anlaşılmasını ve kaynak olarak değerlendirilmesini engelleyebilecek ölçülebilir web sitesi sorunlarını kanıtıyla görün.",
        "cta": "Sitemi Ücretsiz Tara",
    },
    "tr/index.html": {
        "title": "AI Arama Teknik Teşhis ve Düzeltme Platformu | HTML&HTML",
        "description": "Web sitenizin AI aramalarında neden zayıf kaldığını ücretsiz görün. Bulguyu kanıtlayın; gerekiyorsa $99 Fix Pack ile uygulanabilir düzeltme, test ve rollback planını alın.",
    ...
    "en/index.html": {
        "title": "AI Search Technical Diagnostic & Fix Platform | HTML&HTML",
        "description": "See why your website may be weak in AI search. Get evidence-backed diagnosis free; use the $99 Fix Pack when you need implementation, tests and rollback.",
        "h1": "Why Is Your Website Missing From AI Search?",
        "lead": "Enter your URL. See evidence-backed website issues that can block discovery, understanding and source consideration across AI search systems.",
    ...
    "tr/fix-mandate/index.html": {"h1":"Yapay Zeka Görünürlüğünüzün Önündeki Engelleri Uygulanabilir Düzeltme Reçetesine Çevirin.","lead":"$99 Yol Haritası bir tavsiye garantisi değil; ölçülen GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt ve teknik engelleri kök neden, uygulama, test ve rollback planına dönüştüren otomatik yazılım paketidir."},
    "en/fix-mandate/index.html": {"h1":"Turn AI Search Visibility Blockers into a Testable Fix Prescription.","lead":"The $99 Yol Haritası is not a recommendation guarantee. It turns measured GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt and technical blockers into root-cause fixes, tests and rollback plans."},
