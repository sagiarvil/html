...
PAGES = {
    ...
    "tr/fix-mandate/index.html": {"h1":"Yapay Zeka Görünürlüğünüzün Önündeki Engelleri Uygulanabilir Düzeltme Reçetesine Çevirin.","lead":"$99 Fix Mandate bir tavsiye garantisi değil; ölçülen GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt ve teknik engelleri kök neden, uygulama, test ve rollback planına dönüştüren otomatik yazılım paketidir."},
