...
PAGES = {
    ...
    "tr/fix-mandate/index.html": {"h1":"Yapay Zeka Görünürlüğünüzün Önündeki Engelleri Uygulanabilir Düzeltme Reçetesine Çevirin.","lead":"$99 Yol Haritası bir tavsiye garantisi değil; ölçülen GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt ve teknik engelleri kök neden, uygulama, test ve ████████ planına dönüştüren otomatik yazılım paketidir."},
    "en/fix-mandate/index.html": {"h1":"Turn AI Search Visibility Blockers into a Testable Fix Prescription.","lead":"The $99 Yol Haritası is not a recommendation guarantee. It turns measured GEO, AEO, LLMO, AAO, RAG, E-E-A-T, llms.txt and technical blockers into root-cause fixes, tests and ████████."},
