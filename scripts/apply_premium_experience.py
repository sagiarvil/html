...
<section class="px-section" id="tools" data-premium-infographic="tools">
  ...
  <div class="px-lenses">
    ...
    <div class="px-lens"><b>TEKNİK TEMEL</b><span>18 Motor · Teknik SEO · Link · Güvenlik</span></div>
...
TR_REPORT='''<section class="px-report-boundary" data-premium-infographic="report-boundary">
  <article class="px-report-free">
    ...
    <ul>
      <li>✦ 18 deterministik motor skoru ve analizi</li>
      <li>✦ 13 Search &amp; AI Intelligence Audit özeti</li>
      <li>✦ 6 katmanlı derin mimari (GEO, AEO, LLMO, RAG, E-E-A-T)</li>
...
EN_REPORT='''<section class="px-report-boundary" data-premium-infographic="report-boundary">
  <article class="px-report-free">
    ...
    <ul>
      <li>✦ 18 deterministic engine scores &amp; diagnosis</li>
      <li>✦ 13 Search &amp; AI Intelligence Audits summary</li>
      <li>✦ 6 conceptual layers (GEO, AEO, LLMO, RAG, E-E-A-T)</li>
...
def transform_home(rel,lang):
    ...
    if lang=='tr':
        h='<h1 data-i18n="heroTitle">Web Siteniz Yapay Zeka Aramalarında Neden Görünmüyor?</h1>' if rel!='en/index.html' else ''
        text=re.sub(r'<h1 data-i18n="heroTitle">.*?</h1>',h,text,count=1,flags=re.S)
        text=text.replace('<b data-i18n="scan">Yapay Zeka Görünürlüğümü Ücretsiz Kontrol Et</b>','<b data-i18n="scan">Sitemi Ücretsiz Tara</b>').replace('<b data-i18n="scan">Ücretsiz Tara</b>','<b data-i18n="scan">Sitemi Ücretsiz Tara</b>').replace('<b data-i18n="scan">AI Sizi Tavsiye Ediyor mu? Ücretsiz Kontrol Et</b>','<b data-i18n="scan">Sitemi Ücretsiz Tara</b>')

    else:
        text=re.sub(r'<h1[^>]*>Your Customer Asks AI.*?</h1>','<h1 data-i18n="heroTitle">Why Is Your Website Missing From AI Search?</h1>',text,count=1,flags=re.S)
        ...
        text=text.replace('<b data-i18n="scan">Check My AI Visibility Free</b>','<b data-i18n="scan">Scan My Site Free</b>').replace('<b data-i18n="scan">Scan Free</b>','<b data-i18n="scan">Scan My Site Free</b>')
        text=text.replace('<b>Check My AI Visibility Free</b>','<b>Scan My Site Free</b>').replace('<b>Scan Free</b>','<b>Scan My Site Free</b>')
...
def patch_assets():
    js=ROOT/'assets/js/validator.js?v=17'
    if js.exists():
        t=js.read_text(encoding='utf-8').replace('$149','$99').replace("scan:'Yapay Zeka Görünürlüğümü Ücretsiz Kontrol Et'","scan:'Sitemi Ücretsiz Tara'").replace("scan:'Ücretsiz Tara'","scan:'Ücretsiz Kontrol Et'").replace("scan:'Check My AI Visibility Free'","scan:'Scan My Site Free'").replace("scan:'Scan Free'","scan:'Check Free'")
        t=t.replace("heroTitle:'Müşteriniz Yapay Zekaya “Kimi Tavsiye Edersin?” Diye Soruyor. Cevapta Siz Var mısınız?'","heroTitle:'Web Siteniz Yapay Zeka Aramalarında Neden Görünmüyor?'")
