...
<link rel="stylesheet" href="/assets/css/validator.css?v=14">
  ...
  <ol class="px-pipeline-flow">
    ...
    <li class="px-pipeline-step">
      <article class="px-pipeline-card">
        ...
        <p>cl100k AST token ayrıştırma, measured HTML payload, semantic structure and source-readiness evidence</p>
        <div class="pipeline-micro-stream">
          <span>🎯 ColBERT MaxSim</span>
          <span>🧠 Knowledge Vault QID</span>
          <span>📦 measured HTML payload, semantic structure and source-readiness evidence</span>
        </div>
      </article>
    </li>
    <li class="pipeline-flow-arrow" aria-hidden="true">⟶</li>
