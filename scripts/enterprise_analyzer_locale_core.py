...
, r'\\1 findings', translated)
            translated = re.sub(r'^(\\d+)\\s+Motor
...
def main() -> None:
    ...
    print('EA LOCALE CONTRACT PASS: URL SSOT + EN/TR purity + parallel materialization verified')
, r'\\1 engines', translated)
            translated = re.sub(r'^(\\d+)\\s+link probu
...
def main() -> None:
    ...
    if leaks_all:
        ...
        raise SystemExit('\n'.join(lines))
    print('EA LOCALE CONTRACT PASS: URL SSOT + EN/TR purity + parallel materialization verified')
, r'\\1 link probes', translated)
        else:
            translated = re.sub(r'^Target:\\s*', 'Hedef: ', translated)
            translated = re.sub(r'^Weight:\\s*', 'Ağırlık: ', translated)
            translated = re.sub(r'^(\\d+)\\s+findings
...
def main() -> None:
    ...
    if leaks_all:
        ...
        raise SystemExit('\n'.join(lines))
    print('EA LOCALE CONTRACT PASS: URL SSOT + EN/TR purity + parallel materialization verified')
, r'\\1 bulgu', translated)
            translated = re.sub(r'^(\\d+)\\s+Engines
...
def main() -> None:
    ...
    print('EA LOCALE CONTRACT PASS: URL SSOT + EN/TR purity + parallel materialization verified')
, r'\\1 motor', translated)
            translated = re.sub(r'^(\\d+)\\s+link probes
