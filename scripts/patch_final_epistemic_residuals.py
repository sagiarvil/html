#!/usr/bin/env python3
"""Normalize the last fixed-prompt specimen claims after all locale materializers.

This is intentionally narrow and deterministic. It does not alter measured scan
results; it only removes unsupported fixed-count prompt wording from public
specimen/marketing HTML that can be regenerated late in the build chain.
"""
