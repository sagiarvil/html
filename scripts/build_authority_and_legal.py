    ...
    pages = [
        {
            ...
            "en": {
                ...
                "body": """<h2>100% Automated Developer Software (SaaS) & Digital Products</h2><p>HTML&HTML is strictly a 100% automated Software-as-a-Service (SaaS) and developer tooling platform. We develop autonomous website scanning engines, deterministic diagnostic algorithms, and automated digital code artifact generators. Every diagnostic score, technical blueprint, and remediation code file is generated completely deterministically by software algorithms without human intervention.</p><h2>Explicit Exclusion of Marketing, Consulting, and IT Services</h2><p>To ensure total clarity regarding our business model: HTML&HTML <strong>DOES NOT</strong> provide:</p><ul><li>Advertising, marketing campaigns, SEO schemes, or promotional services</li><li>Human consulting, advisory services, agency retainers, or manual auditing</li><li>Bespoke IT services, contract software development, or manual coding labor</li></ul><p>We do not sell agency retainers or human working hours. All products sold on this platform are strictly pre-built or machine-compiled digital goods (software licenses and ZIP archives containing automated code patches and test suites) delivered electronically.</p><h2>The Core Principle: Epistemic Honesty</h2><p>If something cannot be measured from a public crawl, we do not guess. Core Web Vitals return NOT_MEASURED without real user field data. Emerging formats like llms.txt are treated as proposals, not web standards. We never sell ranking guarantees.</p>"""
            },
            "tr": {
                ...
                "body": """<h2>%100 Otomatik Geliştirici Yazılımı (SaaS) ve Dijital Ürünler</h2><p>HTML&HTML, web geliştiricileri ve sistem mimarları için geliştirilmiş %100 otomatik bir Yazılım Hizmeti (SaaS) ve dijital kod üretim platformudur. Platformumuz; otonom web tarayıcı motorları, deterministik teşhis algoritmaları ve anında indirilebilir dijital kod paketleri üretir. Üretilen tüm teşhis raporları, mimari planlar ve kod dosyaları insan müdahalesi olmaksızın algoritmik yazılım motorları tarafından üretilir.</p><h2>Pazarlama, Danışmanlık ve BT Hizmetlerinin Kesin Olarak Reddi</h2><p>İş modelimizin sınırlarını netleştirmek adına: HTML&HTML kesinlikle şunları <strong>SUNMAZ</strong>:</p><ul><li>Reklam, pazarlama hizmetleri veya arama motoru manipülasyon planları</li><li>İnsan danışmanlığı, ajans hizmeti, yönetimsel danışmanlık veya manuel denetimler</li><li>Özel BT hizmetleri, ısmarlama yazılım geliştirme veya insan gücüyle kodlama</li></ul><p>Şirketimiz insan çalışma saati veya danışmanlık satmaz. Satılan tüm ürünler elektronik ortamda anında teslim edilen dijital yazılım lisansları ve otomatik kod paketleridir (ZIP arşivi).</p><h2>Temel İlke: Epistemik Dürüstlük</h2><p>Herkese açık bir taramadan ölçülemeyen hiçbir sinyal uydurulmaz. Saha verisi olmadan Core Web Vitals puanı uydurulmaz, kesinlikle NOT_MEASURED dönülür. llms.txt gibi gelişmekte olan yapılar web standardı değil öneri olarak ele alınır. Asla sıralama garantisi satılmaz.</p>"""
            }
        },
        {
            "id": "contact",
        ...
        },
        {
            ...
            "en": {
                ...
                "body": """<h2>1. Software as a Service (SaaS) & Automated Digital Goods Only</h2><p>HTML&HTML is strictly an automated Software-as-a-Service (SaaS) and developer tooling platform operated by HTML&HTML. The platform provides automated website diagnostic scans and compiles instant digital software packages (ZIP archives containing machine-generated configuration files, code patches, OpenAPI definitions, and automated acceptance test suites).</p><h2>2. Explicit Exclusion of Marketing, Consulting, and IT Services</h2><p>HTML&HTML strictly provides automated software products and digital goods. In accordance with payment network compliance and our operational model, HTML&HTML explicitly <strong>EXCLUDES</strong> and <strong>DOES NOT PROVIDE</strong>:</p><ul><li>Advertising, marketing schemes, SEO consulting, link building, or promotional services;</li><li>Human advisory, management consulting, business advisory, or agency services;</li><li>Custom software development, bespoke programming, IT outsourcing, or human technical labor.</li></ul><p>All diagnostic scores, technical blueprints, configuration templates, and code files are generated 100% deterministically by algorithmic software execution without human intervention.</p><h2>3. Digital Goods License & Instant Electronic Delivery</h2><p>Upon purchase of the $99 AI Search Visibility Roadmap software license, software entitlements and instant digital download links (ZIP archives) are generated and delivered electronically. Because the product consists of instantly delivered digital software assets and machine-generated blueprints, delivery is fulfilled immediately upon cryptographic payment authorization.</p><h2>4. Algorithmic Integrity & Anti-Guarantee Policy</h2><p>HTML&HTML measures compliance against published RFC web specifications, vendor crawler documentation, and deterministic heuristics. We make no representations or guarantees regarding third-party search engine placement, commercial traffic volume, or generative AI citation rankings, as external machine learning algorithms update independently.</p><h2>5. Payment Processing via Paddle (Merchant of Record)</h2><p>All software purchases and digital goods transactions on HTML&HTML are processed securely by Paddle, our Merchant of Record. Paddle provides customer service inquiries and handles returns in accordance with our digital software delivery policy.</p>"""
            },
            "tr": {
                ...
                "body": """<h2>1. Yalnızca Yazılım Hizmeti (SaaS) ve Otomatik Dijital Ürünler</h2><p>HTML&HTML, web geliştiricileri ve sistem mimarları için geliştirilmiş %100 otomatik bir Yazılım Hizmeti (SaaS) ve dijital kod üretim platformudur. Platform, web siteleri için otomatik teknik taramalar gerçekleştirir ve makine tarafından derlenen hazır dijital yazılım paketleri (kod yamaları, konfigürasyon şablonları, OpenAPI tanımları ve regresyon test betikleri içeren ZIP arşivi) üretir.</p><h2>2. Pazarlama, Danışmanlık ve BT Hizmetlerinin Kesin Olarak Reddi</h2><p>HTML&HTML yalnızca bağımsız çalışan otomatik yazılım ürünleri ve dijital kod dosyaları sunar. Ödeme ağı uyumluluğu ve operasyonel modelimiz uyarınca HTML&HTML kesinlikle şunları <strong>SUNMAZ ve REDDEDER</strong>:</p><ul><li>Reklam, pazarlama hizmetleri, SEO danışmanlığı veya tanıtım faaliyetleri;</li><li>İnsan danışmanlığı, yönetim danışmanlığı, iş tavsiyesi veya ajans hizmetleri;</li><li>Özel yazılım geliştirme, ısmarlama programlama, BT dış kaynak kullanımı veya insan gücüyle kodlama.</li></ul><p>Üretilen tüm teşhis raporları, mimari planlar ve kod paketleri insan müdahalesi olmaksızın, tamamen algoritmik yazılım motorları tarafından deterministik olarak oluşturulur.</p><h2>3. Dijital Lisans ve Anında Teslimat</h2><p>Ücretli $99 AI Görünürlük Yol Haritası yazılım lisansı satın alındığında, yazılım yetkilendirmesi ve anlık dijital indirme bağlantısı (ZIP arşivi) elektronik olarak anında üretilir. Ürün, anında teslim edilen dijital kod varlıklarından ve yazılım dosyalarından oluşur.</p><h2>4. Algoritmik Sınırlar ve Garanti Muafiyeti</h2><p>HTML&HTML, web sitelerini RFC şartnameleri, resmi arama motoru/AI dokümanları ve deterministik kurallar çerçevesinde test eder. Dış yapay zeka modelleri ve arama motorları stokastik olarak çalıştığı için kesin sıralama, organik trafik, atıf veya gelir garantisi verilmez.</p><h2>5. Güvenli Ödeme ve Kayıtlı Satıcı (Paddle)</h2><p>HTML&HTML üzerindeki tüm yazılım lisansı ve dijital ürün satışları, Kayıtlı Satıcımız (Merchant of Record) olan Paddle tarafından güvenle işlenir.</p>"""
            }
        }
    ]
